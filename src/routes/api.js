...
Route.post('/v1/getUserData', Registration.UserData);
Route.post('/v1/updateUserData', Registration.UpdateUserData);
Route.post('/v1/deleteUser', Registration.DeleteUser);
